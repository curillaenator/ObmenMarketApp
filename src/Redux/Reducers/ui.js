  ...
  icons: {
    ...
    ctaoffer: {
      idle: (
        ...
        >
          <path
            d="M9.49553 13.2209C9.49553 12.5326 9.06438 12.0974 8.38573 12.0974C8.05838 12.0974 7.81885 12.2082 7.62723 12.3664L3.89863 15.5234C3.39563 15.9506 3.4116 16.6627 3.89863 17.082L7.62723 20.2231C7.81885 20.3893 8.05838 20.5001 8.38573 20.5001C9.06438 20.5001 9.49553 20.0649 9.49553 19.3686V17.9049H15.2521C18.845 17.9049 21.0007 16.1089 21.0007 13.126V12.1845C21.0007 11.3379 20.2981 10.6416 19.4438 10.6416C18.5895 10.6416 17.9028 11.3379 17.9028 12.1845V12.6434C17.9028 14.0834 16.9607 14.9141 15.3559 14.9141H9.49553V13.2209Z"
            fill="white"
          />
          <path
            d="M4.54893 12.3822C3.70261 12.3822 3 11.6938 3 10.8473V9.8978C3 6.91494 5.15572 5.1189 8.74061 5.1189H14.5052V3.62352C14.5052 2.93516 14.9363 2.5 15.615 2.5C15.9423 2.5 16.1739 2.61077 16.3735 2.76901L20.0941 5.91802C20.5891 6.32945 20.5971 7.04154 20.0941 7.46879L16.3735 10.6257C16.1739 10.7919 15.9423 10.9026 15.615 10.9026C14.9363 10.9026 14.5052 10.4596 14.5052 9.77121V8.11758H8.6448C7.032 8.11758 6.09785 8.94044 6.09785 10.3804V10.8473C6.09785 11.6938 5.40323 12.3822 4.54893 12.3822Z"
            fill="white"
            fillOpacity="0.4"
          />
        </svg>
    ...
    readytopay: (
      ...
      >
        <path
          d="M11.9945 24C18.6085 24 24 18.6169 24 12C24 5.38308 18.6085 0 11.9945 0C5.38063 0 0 5.38308 0 12C0 18.6169 5.38063 24 11.9945 24ZM10.5648 18.2129C9.95362 18.2129 9.45157 17.9072 9.10232 17.5141L5.96999 13.9545C5.62074 13.5614 5.5116 13.2448 5.5116 12.8298C5.5116 11.9454 6.25375 11.2466 7.12688 11.2466C7.61801 11.2466 7.97817 11.4759 8.30559 11.8035L10.5648 14.3258L14.8213 7.66515C15.2142 7.05369 15.6508 6.74795 16.251 6.74795C17.1132 6.74795 17.8772 7.41401 17.8772 8.27661C17.8772 8.59327 17.7899 8.94267 17.5607 9.29208L12.06 17.4049C11.7217 17.8963 11.1542 18.2129 10.5648 18.2129Z"
          fill="#33C74C"
        />
      </svg>
    ),
    ...
    online: (
      ...
      >
        <path
          fill="#33C74C"
          d="M8 6.667a5.315 5.315 0 00-3.79 1.58.667.667 0 01-.947-.938A6.648 6.648 0 018 5.333c1.853 0 3.53.757 4.738 1.976a.667.667 0 01-.948.938A5.315 5.315 0 008 6.667z"
        />
        <path
          fill="#33C74C"
          d="M8 9.333a2.66 2.66 0 00-2.018.924.667.667 0 11-1.009-.872A3.992 3.992 0 018 8c1.21 0 2.295.538 3.027 1.385a.667.667 0 11-1.008.872A2.66 2.66 0 008 9.333zM8 13.333a1.333 1.333 0 100-2.666 1.333 1.333 0 000 2.666z"
        />
        <path
          fill="#086343"
          d="M8 4c-2.15 0-4.1.847-5.539 2.227a.667.667 0 11-.923-.962A9.304 9.304 0 018 2.667c2.507 0 4.785.99 6.461 2.598a.667.667 0 01-.923.962A7.971 7.971 0 008 4z"
        />
      </svg>
    ),
  },
