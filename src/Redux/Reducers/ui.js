  ...
  icons: {
    ...
    delete: (
      <svg 
        ...
        <path fill="#FF2B2B" d="M10 12a1 1 0 00-1 1v4a1 1 0 102 0v-4a1 1 0 00-1-1zM14 12a1 1 0 00-1 1v4a1 1 0 102 0v-4a1 1 0 00-1-1z"/>
        <path fill="#FF2B2B" fillRule="evenodd" d="M8 6V5a3 3 0 013-3h2a3 3 0 013 3v1h3a1 1 0 110 2H5a1 1 0 010-2h3zm2-1a1 1 0 011-1h2a1 1 0 011 1v1h-4V5z" clipRule="evenodd"/>
      </svg>
    ),
    delete2: (
      <svg
      ...
      >
        <path
          d="M12 24C18.5647 24 24 18.5647 24 12C24 5.44706 18.5529 0 11.9882 0C5.43529 0 0 5.44706 0 12C0 18.5647 5.44706 24 12 24ZM8.85882 19.1529C8.03529 19.1529 7.55294 18.6941 7.51765 17.8706L7.10588 8.28235H6.10588C5.82353 8.28235 5.6 8.05882 5.6 7.77647C5.6 7.48235 5.82353 7.24706 6.10588 7.24706H9.02353V6.27059C9.02353 5.27059 9.69412 4.62353 10.7529 4.62353H13.2C14.2706 4.62353 14.9412 5.27059 14.9412 6.27059V7.24706H17.8353C18.1294 7.24706 18.3765 7.48235 18.3647 7.77647C18.3529 8.05882 18.1294 8.28235 17.8353 8.28235H16.8824L16.4706 17.8706C16.4471 18.6941 15.9294 19.1529 15.1294 19.1529H8.85882ZM10.2588 7.24706H13.6824V6.34118C13.6824 6.02353 13.4588 5.81177 13.1294 5.81177H10.8118C10.4824 5.81177 10.2588 6.02353 10.2588 6.34118V7.24706ZM9.90588 17.2706C10.1647 17.2706 10.3294 17.0941 10.3176 16.8588L10.0824 9.77647C10.0824 9.51765 9.90588 9.35294 9.65882 9.35294C9.36471 9.35294 9.21177 9.51765 9.21177 9.77647L9.45882 16.8588C9.45882 17.0941 9.64706 17.2706 9.90588 17.2706ZM11.9647 17.2706C12.2353 17.2706 12.4235 17.0941 12.4235 16.8588V9.77647C12.4235 9.51765 12.2471 9.35294 11.9647 9.35294C11.6941 9.35294 11.5294 9.51765 11.5294 9.77647V16.8588C11.5294 17.0941 11.6941 17.2706 11.9647 17.2706ZM14.0353 17.2706C14.2824 17.2706 14.4824 17.0941 14.4824 16.8588L14.7176 9.77647C14.7294 9.51765 14.5647 9.35294 14.2941 9.35294C14.0235 9.35294 13.8471 9.51765 13.8471 9.77647L13.6118 16.8588C13.6118 17.0941 13.7647 17.2706 14.0353 17.2706Z"
          fill="#FF2B2B"
        />
      </svg>
    ),
    back: (
      <svg xmlns="http://www.w3.org/2000/svg" 
        ...
        fill="none" 
        viewBox="0 0 24 24">
        <path fill="#D5B5FF" d="M1 8.822c0-2.738 0-4.107.533-5.153a4.889 4.889 0 012.136-2.136C4.715 1 6.084 1 8.822 1h6.356c2.738 0 4.107 0 5.153.533a4.889 4.889 0 012.136 2.136C23 4.715 23 6.084 23 8.822v6.356c0 2.738 0 4.107-.533 5.153a4.889 4.889 0 01-2.136 2.136C19.285 23 17.916 23 15.178 23H8.822c-2.738 0-4.107 0-5.153-.533a4.889 4.889 0 01-2.136-2.136C1 19.285 1 17.916 1 15.178V8.822z"/>
        <path fill="#7000FF" fillRule="evenodd" d="M14.59 7.366c.547.488.547 1.28 0 1.768L11.38 12l3.21 2.866c.547.488.547 1.28 0 1.768a1.521 1.521 0 01-1.98 0l-4.2-3.75a1.158 1.158 0 010-1.768l4.2-3.75a1.521 1.521 0 011.98 0z" clipRule="evenodd"/>
      </svg>
    ),
    share: (
      <svg 
    ...
    edit: (
      <svg 
        ...
        fill="none" 
        viewBox="0 0 24 24">
        <path fill="#7000FF" d="M4.775 14.658l-1.716 5.016a1 1 0 001.268 1.27l5.022-1.71c.435-.147.83-.393 1.155-.718l.506-.506L6 13l-.508.508a3 3 0 00-.717 1.15z"/>
        <path fill="#D5B5FF" d="M14 5l-8 8 5.01 5.01 8-8L14 5z"/>
        <path fill="#7000FF" d="M15.119 3.881L14 5l5.01 5.01 1.119-1.119a3 3 0 000-4.242l-.768-.768a3 3 0 00-4.242 0z"/>
      </svg>
    ...
    fold: (
      ...
      >
        <path
          className="cta_path1"
          d="M13 0C5.8203 0 0 5.8203 0 13C0 20.1797 5.8203 26 13 26C20.1797 26 26 20.1797 26 13C26 5.8203 20.1797 0 13 0Z"
        />
        <path
          className="cta_path2"
          d="M10.7812 8.18081C11.2888 7.67313 12.1119 7.67313 12.6196 8.18081L16.5196 12.0808C17.0273 12.5885 17.0273 13.4116 16.5196 13.9193L12.6196 17.8193C12.1119 18.327 11.2888 18.327 10.7812 17.8193C10.2735 17.3116 10.2735 16.4885 10.7812 15.9808L13.7619 13L10.7812 10.0193C10.2735 9.51161 10.2735 8.68849 10.7812 8.18081Z"
        />
      </svg>
    ),
  },
